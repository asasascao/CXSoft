...
namespace CXSoft.Flowsh
{
    ...
    public class LogicDelegateInfo : DelegateInfo
    {
        ...
        public DelegateInfo Register(Action action) => 
            Register((Delegate)action, new Dictionary<string, object>(), "");
        ...
        public DelegateInfo Register<R>(Func<R> func, string defaultResName) => 
            Register((Delegate)func, new Dictionary<string, object>(), defaultResName);
        #endregion
        ...
        public DelegateInfo Register<T>(Action<T> action, T param)
        {
            ...
            var parameters = this.Parameters?.Select(parameter => parameter.Name)?.ToArray();
